...
import { detailsOrder, payOrder , deliverOrder} from '../redux/actions/orderAction';
          ...
          <li>
            <div className="card card-body">
              ...
              <p>
                ...
                <strong>Tel:</strong> {order.shipping.tel}  <br />
            ...
            {!order.isPaid && (
                <li>
                  {!sdkReady ? (
                    ...
                    <>
                    {errorPay && (
                      <Error variant="danger">{errorPay}</Error>
                    )}
                    {loadingPay && <Loading/>}
                ...
                <li>
                  ...
                  {errorDeliver && (
                    <Error variant="danger">{errorDeliver}</Error>
                  )}
                  <button
                    type="button"
